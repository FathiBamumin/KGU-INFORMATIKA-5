...
export const gamificationApi = {
  ...
  // Get gamification data for a category grup
  getCategoryGroups: () => apiRequest('getCategoryGroups'),
  ...
  getByStudents: (studentUsername: string) => apiRequest('getGamification', { studentUsername }),
